...
def append_article_to_forward_file(json_file_path=r"C:\DSAProject\myproject\myapi\FI.json"):
    ...
    metadata_dict = {}
    metadata_dict.update(extract_metadata_from_json(r"C:\DSAProject\myproject\myapi\metadata.json"))
...
def append_article_to_inverted_file():
    ...
    inverted_index.build_inverted_index("C:\\DSAProject\\FI.json", r"C:\DSAProject\myproject\myapi\Lexi.json")
