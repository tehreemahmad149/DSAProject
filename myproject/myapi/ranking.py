...
totalDocumentLengthFile = r"C:\Users\user\Documents\GitHub\DSA\myproject\myapi\total_doc_len.json"
    ...
    # Combine scores using weighted sum
        ...
        for barrel, inverted_index in barrel_inverted_indices.items():
            for i, doc_id in enumerate(inverted_index.search_inverted_index(query_tokenized)):
                bm25f_score = Ranking.calculate_bm25f_score(
                    self.forward_index, query_tokenized, doc_id, k1, b, title_boost
                )
